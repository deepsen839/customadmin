...
from customadmin.settings import BASE_DIR
...
class Theme(models.Model):
    ...
    phone_number = models.CharField(max_length=200,default='+91 6361662946',verbose_name=_("Phone Number"))
    facebook_url = models.CharField(max_length=200,default='',verbose_name=_("FaceBook Url"))
    linked_url = models.CharField(max_length=200,default='',verbose_name=_("Linkedin Url"))
    whatsapp_url = models.CharField(max_length=200,default='',verbose_name=_("Whatsapp Url"))
    ...
    logo = models.FileField(
        upload_to="admin_interface/static/logo/",
        blank=True,
        validators=[
    ...
    favicon = models.FileField(
        upload_to="admin_interface/static/favicon/",
        blank=True,
        validators=[
            FileExtensionValidator(
